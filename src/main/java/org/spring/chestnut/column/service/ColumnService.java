...
public interface ColumnService {
    ...
    ColumnEntity createColumn(Long boardId, ColumnRequestDto requestDto, UserDetailsImpl userDetails);

    ColumnEntity updateColumn(Long columnId, ColumnRequestDto requestDto, UserDetailsImpl userDetails);

    ColumnEntity updateSecuence(Long columnId, ColumnSequenceRequestDto requestDto, UserDetailsImpl userDetails);
